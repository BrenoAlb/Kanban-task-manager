		...
		<div class="menu container">
			...
			<div id="navbarSupportedContent" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
                    <li><a href="content.php" class="btn btn-outline-dark mr-2"><i class="fas fa-home pr-2"></i>Página inicial</a></li>	
    ...
    <div class="col-3 p-0 pl-3 pr-1">
        <div class="card-hover-shadow-2x mb-3 card text-dark">
            <div class="card-header-tab card-header d-flex flex-nowrap justify-content-between">
                <h4 class="card-header-title font-weight-normal"><i class="fa fa-suitcase mr-3"></i> PROJETOS de <?php echo strtoupper($_SESSION['user']);?></h4>
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#project-modal">+</button>
            </div>
                                ...
                                <?php if (isset($projects)) {	
                                    ...
                                    <div class="todo-indicator" style="background-color:<?php echo $p['project_colour'];?>;">
                                        ...
                                        <div class="widget-content p-0">
                                                ...
                                                <form name="id_project_task" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="GET" role="form">
                                                    ...
                                                    <button class="btn" type="submit">
                                                        <div class="widget-content-left">
                                                            <div class="text-left widget-heading text-info">
                                                                <?php echo $p['project_name'];?>                                                                
                                                            </div>                                                            
                                                            <div class="widget-subheading text-muted"><i>Início: <?php echo $p['start_date'];?></i></div>
                                                            <div class="widget-subheading text-muted"><i>fim: <?php echo $p['end_date'];?></i></div>                                                       
                                            ...
                                            <a class="d-flex justify-content-center nav-link text-info p-0" data-toggle="collapse" data-target="#collapse-p-<?php echo $i; ?>" aria-expanded="true">
    ...
    <div class="col-9 p-0 pr-3 pl-1">
        <div class="card-hover-shadow-2x mb-3 card text-dark">
            <div class="card-header-tab card-header d-flex justify-content-between">
                <h4 class="card-header-title font-weight-normal"><i class="fas fa-clipboard-list pr-3"></i>TAREFAS</h4>
                <?php if (isset($show_tasks)) { 
                    echo"<button type='button' class='btn btn-info' data-toggle='modal' data-target='#new-task-modal'>Nova tarefa</button>";
                        ...
                        <div class="ps-content">
                            <div class="row m-2 mt-4">
                                <div class="col-4">
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        <div class="card-header-tab card-header">
                                            <h5 class="card-header-title font-weight-normal"><i class="fas fa-list mr-3"></i>PARA FAZER</h5>                                            
                                        </div>
                                                    ...
                                                    <div class="ps-content">
                                                        ...
                                                        ?>  
                                                            <li class="accordion list-group-item pe-auto" id="task-todo-<?php echo $i; ?>">                                                                      
                                                                ...
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        <a class="col-8 nav-link text-info p-0" data-toggle="collapse" data-target="#collapse-todo-<?php echo $i; ?>" aria-expanded="true">
                                                                ...
                                                                <div class="d-flex justify-content-center">                                                                    
                                                                    ...
                                                                    <form name="id_task_right-<?php echo $i; ?>" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" role="form">
                                                                        ...
                                                                        <button type="submit" class="border-0 btn-transition btn btn-outline-info"> <i class="fa fa-arrow-right"></i></button>
                                                                    </form>     
                                                                </div>                                    
                                                            </li>
                                ...
                                <div class="col-4">
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        <div class="card-header-tab card-header d-flex justify-content-between">
                                            <h5 class="card-header-title font-weight-normal"><i class="fas fa-cogs mr-3"></i>EM PROGRESSO</h5>                                            
                                        </div>
                                        <div class="scroll-area-sm">
                                            <perfect-scrollbar class="ps-show-limits">
                                                <div style="position: static;" class="ps ps--active-y">
                                                    <div class="ps-content">
                                                        ...
                                                        <li class="accordion list-group-item pe-auto" id="task-ip-<?php echo $i; ?>">        
                                                                ...
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        <a class="col-8 nav-link text-info p-0" data-toggle="collapse" data-target="#collapse-ip-<?php echo $i; ?>" aria-expanded="true">
                                                                            <div class="widget-content-left p-2 pl-3">
                                                                                <div class="widget-heading d-flex">                                                                                   
                                                                                <?php echo $s['task_name'];?>                                                                                                                                                             
                                                                                    <span class="accicon"><i class="fa fa-angle-down rotate-icon pl-2"></i></span>
                                                                ...
                                                                <div class="d-flex justify-content-center">   
                                                                    <form name="id_task_left-<?php echo $i; ?>" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" role="form">
                                                                        ...
                                                                        <button type="submit" class="border-0 btn-transition btn btn-outline-info"> <i class="fa fa-arrow-left"></i></button>
                                                                    </form>
                                                                    <form name="id_task_right-<?php echo $i; ?>" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" role="form">
                                                                        <input hidden name="id_task_right" value=<?php echo $s['id_task']; ?> >
                                                                        <input hidden name="task_status" value=<?php echo $s['task_status']; ?> >           
                                ...
                                <div class="col-4">
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        <div class="card-header-tab card-header d-flex justify-content-between">
                                            <h5 class="card-header-title font-weight-normal"><i class="fas fa-check mr-3"></i>COMPLETO</h5>                                            
                                        </div>
                                        <div class="scroll-area-sm">
                                            <perfect-scrollbar class="ps-show-limits">
                                                <div style="position: static;" class="ps ps--active-y">
                                                    <div class="ps-content">
                                                        ...
                                                        ?>  
                                                            ...
                                                            <li class="accordion list-group-item pe-auto" id="task-c-<?php echo $i; ?>">        
                                                                ...
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        <a class="col-8 nav-link text-info p-0" data-toggle="collapse" data-target="#collapse-c-<?php echo $i; ?>" aria-expanded="true">
                                                                            <div class="widget-content-left p-2 pl-3">
                                                                                <div class="widget-heading d-flex">                                                                                   
                                                                                <?php echo $s['task_name'];?>                                                                                                                                                             
                                                                                    <span class="accicon"><i class="fa fa-angle-down rotate-icon pl-2"></i></span>
