		...
		<div class="menu container">
			...
			<div id="navbarSupportedContent" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
					<li><a href="login.php" class="btn btn-outline-dark btn-info mr-2"></i>Login</a></li>				
				</ul>
			</div>
		</div>
	</nav>
...
<div class="container">
	<div class="d-flex justify-content-center row m-0 p-0">
		...
		<div class="col-6 p-5 justify-content-center">
			<p class="text-center h1 fw-bold m-5">Registrar</p>
			<form class="px-5" name="signup" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
				...
				<div class="mb-4">					
					<div class="input-group">
						<div class="input-group-prepend">
						<span class="btn btn-lg  input-group-text"> <small><i class="fas fa-key"></i></small></span>
						</div>					
						<input class="form-control" type="password" name="password2" placeholder="Confirme a Senha" required>
					</div>
				</div>

				<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
				<button type="button" class="btn btn-outline-light btn-info" onclick="signup.submit()">Registrar</button>
				</div>
			...
			<span class="d-flex justify-content-center">Já tem uma conta?<a class="nav-link text-info text-light m-0 p-0 pl-2" href="login.php">Faça o 	Login</a></span>			
		</div>
		...
		<div class="col-12">
			<div class="container d-flex justify-content-center">
				<ul class="list-unstyled list-inline text-center d-flex justify-content-center align-items-center">				
					...
					<small><span class="ml-2">Created by<a class="nav-link d-inline-block text-primary pl-1" href="https://github.com/BrenoAlb" target="_blank">Breno Alberto</a></span></small>               
				</ul>
			</div>
		</div>
	</div>
