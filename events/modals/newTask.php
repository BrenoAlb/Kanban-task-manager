    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="lead text-info" >Criar nova tarefa</h3>
            ...
            <form name="task_todo" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" role="form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="text-dark" for="task_name">Nome da tarefa<span class="text-danger pl-1">*</span></label>
					...
					<div class="form-group">
						<label for="task_colour" class="text-dark">Prioridade</label>
						<select name="task_colour" class="form-control">
							<option value=""></option>
							<option style="color:#5cb85c" value="#5cb85c">&#9724; Baixa</option>						  
							<option style="color:#f0ad4e" value="#f0ad4e">&#9724; Mediana</option>
							<option style="color:#d9534f" value="#d9534f">&#9724; Alta</option>													  
						</select>
				    </div>         
                    <div class="form-group d-flex justify-content-between mt-2">
                        <div class="col-12 m-0 p-1">  
                            <label class="text-dark">Prazo final</label>
