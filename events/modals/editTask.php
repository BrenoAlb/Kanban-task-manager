    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="lead text-primary" >Edite sua tarefa</h3>
            ...
            <form name="task" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" role="form">
                <div class="modal-body">				
                    <div class="form-group">
                        <label class="text-dark" for="edit_name">Nome da tarefa<span class="text-danger pl-1">*</span></label>
					...
					<div class="form-group">
                        ...
                        <?php 
                         if ($s['task_colour'] == '#5cb85c') {echo "Verde";} 
                         elseif ($s['task_colour'] == '#f0ad4e') {echo "Laranja";} 
                         elseif ($s['task_colour'] == '#d9534f') {echo "Vermelho";} 
                         else { echo ""; } ?>                      
                    ...
                    <div class="form-group d-flex justify-content-between mt-2">
                        <div class="col-12 m-0 p-1">  
                            <label class="text-dark">Frazo final</label>
