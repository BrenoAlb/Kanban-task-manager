    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="lead text-info" >Edite seu projeto</h3>
            ...
            <form name="project" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" role="form">
                <div class="modal-body">				
					...
					<div class="form-group">
                        ...
                        <?php 
                         if($p['project_colour'] == '#0275d8') {echo "Azul";} 
                         elseif ($p['project_colour'] == '#5bc0de') {echo "Azul claro";} 
                         elseif ($p['project_colour'] == '#5cb85c') {echo "Verde";} 
                         elseif ($p['project_colour'] == '#f0ad4e') {echo "Laranha";} 
                         elseif ($p['project_colour'] == '#d9534f') {echo "Vermelho";} 
                         elseif ($p['project_colour'] == '#292b2c') {echo "Preto";} 
                         else { echo ""; } ?>                      
